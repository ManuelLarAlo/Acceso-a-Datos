package es.aad.LaraAlosManuel.Unidad3.utils;
...
public class ConcesionarioException extends Exception{
	...
	public ConcesionarioException(int code, String message)
	{
		this.code = code;
		this.message = message;
	}
	
	public ConcesionarioException(int code, String message, Exception exception) 
	{
