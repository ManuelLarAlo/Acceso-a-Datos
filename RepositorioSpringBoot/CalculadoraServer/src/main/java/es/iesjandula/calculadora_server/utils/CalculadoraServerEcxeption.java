package es.iesjandula.calculadora_server.utils;
...
public class CalculadoraServerEcxeption extends Exception
{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4296235617902856903L;
	 ...
	 */
	public CalculadoraServerEcxeption(int code, String message) 
	{
		super(message);
	 ...
	 */
	public CalculadoraServerEcxeption(int code, String message, Exception exception) 
	{
